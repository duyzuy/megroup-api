...
function load_custom_wp_admin_style() {
    ...
    wp_enqueue_script( 'neotheme-js', $uri.'/assets/js/admin/product.js',  array('jquery'), $version, false );
    wp_enqueue_style( 'neotheme-css', $uri.'/assets/css/admin/global.css', array(), $version, 'all');
}
