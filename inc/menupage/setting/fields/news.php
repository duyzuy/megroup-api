    ...
    <div class="pyre_col">
        <div class="pyre_metabox_field">
            ...
            <div class="pyre_field">
                <input 
                    id="<?php echo $label; ?>_title"
                    name="dvu_options_home[<?php echo esc_attr( $args['label_for'] ); ?>][title]"
                    class="form-control"
                    type="text"
        ...
        <label for="<?php echo $label; ?>_description">Mô tả</label>
            <div class="pyre_field">
                <textarea 
                id="<?php echo $label; ?>_description"  
                class="form-control" 
                name="dvu_options_home[<?php echo esc_attr( $args['label_for'] ); ?>][description]"
                rows="3" cols="20"
                ><?php echo isset($data['description']) ? sanitize_text_field( $data['description'] ) : ""; ?></textarea>
            </div>
        </div>
        <div class="pyre_metabox_field">
            ...
            <div class="pyre_field">
              ...
              <input 
                    name="dvu_options_home[<?php echo esc_attr( $args['label_for'] ); ?>][thumbnail]"
                    class="form-control"
                    type="hidden"
