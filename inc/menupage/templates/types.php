...
<div class="wrap nosubsub">
    <h1 class="wp-heading-inline">Loại cửa hàng</h1>
    ...
    <?php 
        ...
        if( 'POST' == $_SERVER['REQUEST_METHOD'] && $_POST['action'] == 'add-tag') {
            ...
            if ($_POST['tag-name'] == '') {
                ...
                echo '  <div id="message" class="notice notice-success"><p><strong>Không để trống tên loại cửa hàng.</strong></p></div>';
                ...
                ?>
                    <div id="message" class="notice notice-success"><p><strong>Thêm thành công.</strong></p></div>
                <?php
            }
        }
